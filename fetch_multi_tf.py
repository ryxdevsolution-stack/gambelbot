"""Fetch 8 weeks of 15-min, 30-min, and 1-hour candles for the top real
open markets, caching each to data/search_{ASSET}_{PERIOD}s.csv, for
offline pattern search across longer timeframes.
...
HOURS = 1344  # 8 weeks
MIN_REAL_MARKETS = 10
PERIODS = [900, 1800, 3600]  # 15min, 30min, 1hr
